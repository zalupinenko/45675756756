...
\u041A\u0443\u0440\u0441: ${String(created.offer.rate)}`,
        ...
        if (tgId && username) {
          ...
          if (isPrivateChat && t.startsWith("/start")) {
            ...
            const kb = {
              inline_keyboard: [
                [{ text: "\u0421\u0430\u0439\u0442 \u043E\u0431\u043C\u0435\u043D\u043D\u0438\u043A\u0430", url: env.WEBSITE_URL || "https://crossflag.org" }],
                [
                  { text: "\u041C\u0438\u043D\u0438-\u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u0435", web_app: { url: env.WEBSITE_URL || "https://crossflag.org" } },
                  { text: "\u041F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0430", url: env.SUPPORT_TG_URL || "https://t.me/crossflag2" }
                ]
              ]
            };
